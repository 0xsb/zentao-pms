...
INSERT INTO `zt_action`(`id`,`objectType`,`objectID`,`product`,`project`,`actor`,`action`,`date`,`comment`,`extra`,`read`) VALUES ('364','task','22',',,','7','fuwenjing','recordestimate','2017-09-18 23:13:48','','8','0');
...
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('140','tangfei','my','流程图','','flowchart','','1','8','0','0');
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('141','tangfei','my','最新动态','','dynamic','','2','4','0','0');
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('142','tangfei','my','进行中的项目','project','list','{\"num\":15,\"orderBy\":\"id_desc\",\"type\":\"undone\"}','3','8','0','0');
...
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('144','tangfei','my','未关闭的产品','product','list','{\"num\":15,\"type\":\"noclosed\"}','5','8','0','0');
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('145','tangfei','my','指派给我的任务','project','task','{\"num\":15,\"orderBy\":\"id_desc\",\"type\":\"assignedTo\"}','6','4','0','0');
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('146','tangfei','my','指派给我的Bug','qa','bug','{\"num\":15,\"orderBy\":\"id_desc\",\"type\":\"assignedTo\"}','7','4','0','0');
...
INSERT INTO `zt_block`(`id`,`account`,`module`,`title`,`source`,`block`,`params`,`order`,`grid`,`height`,`hidden`) VALUES ('148','tangfei','my','指派给我的用例','qa','case','{\"num\":15,\"orderBy\":\"id_desc\",\"type\":\"assigntome\"}','9','4','0','0');
...
INSERT INTO `zt_burn`(`project`,`date`,`estimate`,`left`,`consumed`) VALUES ('7','2017-09-18','30','5','24');
...
INSERT INTO `zt_case`(`id`,`product`,`branch`,`lib`,`module`,`path`,`story`,`storyVersion`,`title`,`precondition`,`keywords`,`pri`,`type`,`stage`,`howRun`,`scriptedBy`,`scriptedDate`,`scriptStatus`,`scriptLocation`,`status`,`color`,`frequency`,`order`,`openedBy`,`openedDate`,`reviewedBy`,`reviewedDate`,`lastEditedBy`,`lastEditedDate`,`version`,`linkCase`,`fromBug`,`fromCaseID`,`deleted`,`lastRunner`,`lastRunDate`,`lastRunResult`) VALUES ('4','1','0','0','0','0','3','2','成果展示测试用例','','','3','feature','feature','','','0000-00-00','','','normal','','1','0','tester2','2012-06-05 11:04:48','','0000-00-00','','0000-00-00 00:00:00','1','','0','0','0','tianliwei','2017-09-18 23:21:00','pass');
...
INSERT INTO `zt_config`(`id`,`owner`,`module`,`section`,`key`,`value`) VALUES ('646','tangfei','project','','homepage','index');
...
INSERT INTO `zt_cron`(`id`,`m`,`h`,`dom`,`mon`,`dow`,`command`,`remark`,`type`,`buildin`,`status`,`lastTime`) VALUES ('1','*','*','*','*','*','','监控定时任务','zentao','1','normal','2017-09-19 00:30:44');
INSERT INTO `zt_cron`(`id`,`m`,`h`,`dom`,`mon`,`dow`,`command`,`remark`,`type`,`buildin`,`status`,`lastTime`) VALUES ('2','30','23','*','*','*','moduleName=project&methodName=computeburn','更新燃尽图','zentao','1','normal','2017-09-18 23:30:43');
INSERT INTO `zt_cron`(`id`,`m`,`h`,`dom`,`mon`,`dow`,`command`,`remark`,`type`,`buildin`,`status`,`lastTime`) VALUES ('3','0','8','*','*','*','moduleName=report&methodName=remind','每日任务提醒','zentao','1','normal','2017-09-18 08:00:12');
...
INSERT INTO `zt_cron`(`id`,`m`,`h`,`dom`,`mon`,`dow`,`command`,`remark`,`type`,`buildin`,`status`,`lastTime`) VALUES ('6','30','0','*','*','*','moduleName=backup&methodName=backup','备份数据和附件','zentao','1','running','2017-09-19 00:30:44');
INSERT INTO `zt_cron`(`id`,`m`,`h`,`dom`,`mon`,`dow`,`command`,`remark`,`type`,`buildin`,`status`,`lastTime`) VALUES ('7','*/5','*','*','*','*','moduleName=mail&methodName=asyncSend','异步发信','zentao','1','normal','2017-09-19 00:25:44');
...
INSERT INTO `zt_doclib`(`id`,`product`,`project`,`name`,`acl`,`groups`,`users`,`main`,`order`,`deleted`) VALUES ('11','0','7','项目主库','open','','','1','0','0');
...
INSERT INTO `zt_grouppriv`(`group`,`module`,`method`) VALUES ('17','product','dynamic');
INSERT INTO `zt_grouppriv`(`group`,`module`,`method`) VALUES ('17','product','index');
INSERT INTO `zt_grouppriv`(`group`,`module`,`method`) VALUES ('17','product','roadmap');
...
INSERT INTO `zt_project`(`id`,`isCat`,`catID`,`type`,`parent`,`name`,`code`,`begin`,`end`,`days`,`status`,`statge`,`pri`,`desc`,`openedBy`,`openedDate`,`openedVersion`,`closedBy`,`closedDate`,`canceledBy`,`canceledDate`,`PO`,`PM`,`QD`,`RD`,`team`,`acl`,`whitelist`,`order`,`deleted`) VALUES ('6','0','0','sprint','0','很快就会狂欢节','lkk','2017-09-15','2017-10-15','21','done','1','1','','','0','9.5','','0','','0','','','','','很快就会狂欢节','open','','30','0');
INSERT INTO `zt_project`(`id`,`isCat`,`catID`,`type`,`parent`,`name`,`code`,`begin`,`end`,`days`,`status`,`statge`,`pri`,`desc`,`openedBy`,`openedDate`,`openedVersion`,`closedBy`,`closedDate`,`canceledBy`,`canceledDate`,`PO`,`PM`,`QD`,`RD`,`team`,`acl`,`whitelist`,`order`,`deleted`) VALUES ('7','0','0','sprint','0','有财1.6运营','1.6','2017-09-18','2017-10-18','23','wait','1','1','','','0','9.5','','0','','0','','','','','有财1.6运营','open','','35','0');
...
INSERT INTO `zt_task`(`id`,`project`,`module`,`story`,`storyVersion`,`fromBug`,`name`,`type`,`pri`,`estimate`,`consumed`,`left`,`deadline`,`status`,`color`,`mailto`,`desc`,`openedBy`,`openedDate`,`assignedTo`,`assignedDate`,`estStarted`,`realStarted`,`finishedBy`,`finishedDate`,`canceledBy`,`canceledDate`,`closedBy`,`closedDate`,`closedReason`,`lastEditedBy`,`lastEditedDate`,`deleted`) VALUES ('22','7','0','0','1','0','维护20个用户','affair','1','30','8','0','2017-09-23','done','','','维护20个用户','tangfei','2017-09-18 23:08:06','tangfei','2017-09-18 23:13:48','2017-09-18','2017-09-18','fuwenjing','2017-09-18 23:13:48','','0000-00-00 00:00:00','','0000-00-00 00:00:00','','fuwenjing','2017-09-18 23:13:48','0');
...
INSERT INTO `zt_testrun`(`id`,`task`,`case`,`version`,`assignedTo`,`lastRunner`,`lastRunDate`,`lastRunResult`,`status`) VALUES ('1','1','4','1','','tianliwei','2017-09-18 23:21:00','pass','done');
...
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('20','23','qiuqingqiang','c2418d98f9898631f84bc9d166289a37','td','邱庆强','','','','0000-00-00','m','qiuqingqiang@chinanuoyi.cn','','','','','','','','','','0000-00-00','8','182.150.151.217','1505747834','0','0000-00-00 00:00:00','','0');
...
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('22','19','tianliwei','c2418d98f9898631f84bc9d166289a37','qd','田李伟','','','','0000-00-00','m','tianliwei@chinanuoyi.cn','','','','','','','','','','0000-00-00','9','182.150.151.217','1505747929','0','0000-00-00 00:00:00','','0');
...
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('26','20','zhating','c2418d98f9898631f84bc9d166289a37','dev','查婷','','','','0000-00-00','m','zhating@chinanuoyi.cn','','','','','','','','','','0000-00-00','4','125.70.31.127','1505697322','0','0000-00-00 00:00:00','','0');
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('27','24','lanmaoyun','c2418d98f9898631f84bc9d166289a37','yy','兰茂云','','','','0000-00-00','m','lanmaoyun@chinanuoyi.cn','','','','','','','','','','0000-00-00','5','182.150.151.217','1505747424','0','0000-00-00 00:00:00','','0');
...
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('30','24','tangfei','c2418d98f9898631f84bc9d166289a37','yy','汤飞','','','','0000-00-00','m','tangfei@chinanuoyi.cn','','','','','','','','','','0000-00-00','2','182.150.151.217','1505747102','0','0000-00-00 00:00:00','','0');
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('31','24','fuwenjing','c2418d98f9898631f84bc9d166289a37','yy','伏文婧','','','','0000-00-00','m','fuwenjing@chinanuoyi.cn','','','','','','','','','','0000-00-00','1','182.150.151.217','1505747603','0','0000-00-00 00:00:00','','0');
INSERT INTO `zt_user`(`id`,`dept`,`account`,`password`,`role`,`realname`,`nickname`,`commiter`,`avatar`,`birthday`,`gender`,`email`,`skype`,`qq`,`yahoo`,`gtalk`,`wangwang`,`mobile`,`phone`,`address`,`zipcode`,`join`,`visits`,`ip`,`last`,`fails`,`locked`,`ranzhi`,`deleted`) VALUES ('32','24','jiangdandan','c2418d98f9898631f84bc9d166289a37','yy','蒋丹丹','','','','0000-00-00','m','jiangdandan@chinanuoyi.cn','','','','','','','','','','0000-00-00','0','','0','0','0000-00-00 00:00:00','','0');
